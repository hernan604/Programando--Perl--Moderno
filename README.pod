...
O público álvo deste tutorial é principalmente novos programadores da linguagem perl. A intenção é que este manual tenha qualidade suficiente para servir e atrair mais e mais programadores ao fantástico universo da linguagem perl.
